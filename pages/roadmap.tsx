    ...
    <section className={styles.main}>
        {connectionStatus === "connected" ? (
          ...
          <div className={styles.section}>
           ...
           <Image src="/images/roadmap.jpg" alt="MINK NFT Roadmap" className={styles.roadmapImage} /></div>
           <div className={styles.roadmap}>
            <h1>Roadmap</h1>
            <ul>
              <li>Establish Mink Coin social media presence to promote the upcoming minting.</li>
              <li>Launch Mink Coin claim phase to allow users to secure their NFTs.</li>
              ...
              <li>Initiate the burn phase on September 6th.</li>
              <li>Launch staking opportunities starting September 6th.</li>
              <li>Set the yield for MINK NFT's at 4.2069.</li>
              <li>Introduce the live marketplace for buying and selling MINK NFT's.</li>  
          ...
          <section className={styles.container}>
            <div>
              ...
              <h1 id="welcomeH1">Welcome to the MINK NFT's</h1>
            </div>
          </section>
        )}
      </section>
